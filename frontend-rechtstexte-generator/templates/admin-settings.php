...
<div class="wrap frg-admin">
	...
	<form method="post" id="frg-settings" class="frg-admin-card">
		...
		<table class="form-table" role="presentation">
			...
			<tr><th scope="row"><?php esc_html_e( 'Generator-Hinweis in Rechtstexten', 'frontend-rechtstexte-generator' ); ?></th><td><label><input type="checkbox" name="show_generator_notice_impressum" value="1" <?php checked( ! empty( $settings['show_generator_notice_impressum'] ) ); ?>> <?php esc_html_e( 'Hinweis im generierten Impressum anzeigen', 'frontend-rechtstexte-generator' ); ?></label><br><label><input type="checkbox" name="show_generator_notice_privacy" value="1" <?php checked( ! empty( $settings['show_generator_notice_privacy'] ) ); ?>> <?php esc_html_e( 'Hinweis in der generierten Datenschutzerklärung anzeigen', 'frontend-rechtstexte-generator' ); ?></label><p class="description"><?php esc_html_e( 'Standardmäßig bleibt dieser interne Hinweis in veröffentlichten Rechtstexten ausgeblendet.', 'frontend-rechtstexte-generator' ); ?></p></td></tr>
